...
<body>
    ...
    <div class="nav-tabs">
        ...
        <div class="nav-tab" onclick="switchTab('db', this)">Database</div>
        <div class="nav-tab" onclick="switchTab('circuit', this)">Circuit Breakers</div>
        <div class="nav-tab" onclick="switchTab('usability', this)">Usabilidade</div>
        <div class="nav-tab" onclick="switchTab('analytics', this)">Analytics</div>
        <div class="nav-tab" onclick="switchTab('audit', this)">Auditoria</div>
        <div class="nav-tab" onclick="switchTab('alert-history', this)">Histórico Alertas</div>
    </div>
    ...
    <script>
        // Global function for tab switching - define immediately
        ...
        function updateRecommendations(recs) {
            ...
            container.innerHTML = recs.map(rec => {
                ...
                else if (rec.includes('WARN') || rec.includes('⚠'))) cls = 'rec-warning';
