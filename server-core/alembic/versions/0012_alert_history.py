...
def downgrade() -> None:
    op.drop_index("ix_alert_name", "alert_history")
    op.drop_index("ix_alert_unresolved", "alert_history")
    op.drop_index("ix_alert_group_fired", "alert_history")
    op.drop_index("ix_alert_fired_severity", "alert_history")
