...
def downgrade() -> None:
    op.drop_index("ix_dash_metric_recorded", "dashboard_metrics")
    op.drop_index("ix_dash_metric_name_time", "dashboard_metrics")
    op.drop_index("ix_dash_metric_group_time", "dashboard_metrics")
